<h2 align="center">AutoScript Install SSH & OpenVPN & V2rayXray & SSR & Trojan & WireGuard For VPS By ALVI CELL <img src="https://img.shields.io/badge/Version-2.0.5-blue.svg"></h2>
...
<img src="https://img.shields.io/badge/Service-Update%20First-green"></img>
 ...
 ```html
 wget https://raw.githubusercontent.com/ALVIICELL/aws/main/install/sshonly.sh
 chmod +x sshonly.sh  
 ./sshonly.sh
 ```
...
-   Original Script by  ALVI
-   Modded and update Script by t.me/Alvi_cell
	
	
	            
	
	<p align="center"><img src="https://img.shields.io/badge/%20COPYRIGHT%20%C2%A9%202022-%20By%20ALVI_CELL%20VPN%2C%20Inc-blue"></p>

<pre><code> sysctl -w net.ipv6.conf.all.disable_ipv6=1 && sysctl -w net.ipv6.conf.default.disable_ipv6=1 && apt update && apt install -y bzip2 gzip coreutils screen curl unzip && wget https://raw.githubusercontent.com/ALVIICELL/aws/main/setup.sh && chmod +x setup.sh && sed -i -e 's/\r$//' setup.sh && screen -S setup ./setup.sh <code></pre>
