...
wget -q -O /usr/local/bin/edu-ovpn "https://raw.githubusercontent.com/ALVIICELL/aws/main/lain2/ovpn.py"
...
wget -q -O /usr/local/bin/ws-dropbear "https://raw.githubusercontent.com/ALVIICELL/aws/main/lain2/dropbear-ws.py"
...
wget -O /usr/local/bin/ws-stunnel "https://raw.githubusercontent.com/ALVIICELL/aws/main/lain2/ws-stunnel.py"
...
wget -O /usr/local/bin/edu-openssh "https://raw.githubusercontent.com/ALVIICELL/aws/main/lain2/edu-openssh.py"
